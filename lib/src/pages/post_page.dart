...
class _PostPageState extends State<PostPage> {
  ...
  Map<String, dynamic> getFloatingIconButton(addedToFavorites, comesFromFavorites, AbstractPost post, FavoritesCubit favCubit) {
    final defaultMethod = () {
       PostService
        .addToFavorites(post)
        .then((bool added) {
  ...
  Widget build(BuildContext context) {
    ...
    final _buttonData = getFloatingIconButton(_addedToFavorites, args.comesFromFavorites, args.post, _favCubit);
